...
-- Users can read all document assignments
CREATE POLICY "Authenticated users can read document assignments"
  ON document_assignments FOR SELECT
  TO authenticated
  USING (true);

-- Users can create assignments for documents they uploaded
CREATE POLICY "Users can create document assignments"
